...
/***/ "./src/carousel-featured/index.js"
/*!****************************************!*\
  !*** ./src/carousel-featured/index.js ***!
  \****************************************/
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/carousel-featured/block.json");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./style.scss */ "./src/carousel-featured/style.scss");
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)((_wordpress_server_side_render__WEBPACK_IMPORTED_MODULE_6___default()), {
        ...
        EmptyResponsePlaceholder: () => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Placeholder, {
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Carousel Featured', 'livemuseum'),
          instructions: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Nessun post trovato per le categorie selezionate.', 'livemuseum')
        })
      })
    })]
  });
...
/***/ "./src/carousel-featured/style.scss"
/*!******************************************!*\
  !*** ./src/carousel-featured/style.scss ***!
  \******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/carousel-featured/block.json"
/*!******************************************!*\
  !*** ./src/carousel-featured/block.json ***!
  \******************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"livemuseum/carousel-featured","version":"1.0.0","title":"LiveMuseum — Carousel Featured (3D)","category":"widgets","icon":"slides","description":"Carousel con slide centrale ingrandita in stile 3D. Sorgente: post WordPress filtrati per categorie selezionate.","textdomain":"livemuseum","supports":{"html":false,"align":["full","wide"]},"attributes":{"heading":{"type":"string","default":"Mostre ed eventi"},"linkLabel":{"type":"string","default":"Scopri di più"},"linkUrl":{"type":"string","default":""},"postSource":{"type":"string","default":"all","enum":["all","current_category","fixed_categories"]},"categoryIds":{"type":"array","default":[],"items":{"type":"number"}},"postCount":{"type":"number","default":20}},"render":"file:./render.php","editorScript":"file:./index.js","viewScriptModule":"file:./view.js","style":"file:./style-index.css"}');
...
/******/ 		var installedChunks = {
/******/ 			"carousel-featured/index": 0,
/******/ 			"carousel-featured/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["carousel-featured/style-index"], () => (__webpack_require__("./src/carousel-featured/index.js")))
